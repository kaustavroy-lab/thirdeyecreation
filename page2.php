...
<link href="third_eye_creation.css?v=59" rel="stylesheet">
<link href="page2.css?v=59" rel="stylesheet">
<script src="jquery-1.12.4.min.js"></script>
<script src="wb.lazyload.min.js"></script>
<script src="wb.stickylayer.min.js"></script>
<script src="page2.js?v=59"></script>
</head>
<body>
<div id="container">
</div>
...
<div id="wb_Image1">
<a href="./index.html"><img src="images/placeholder.gif" data-src="images/third%20eye%203%20png.png" id="Image1" alt=""></a>
</div>
<div id="FlexGrid1">
<div class="header">
<div id="wb_TabMenu1">
...
<div class="row">
<div class="col-1">
<div id="wb_page1LayoutGrid7">
<div id="page1LayoutGrid7">
<div class="row">
<div class="col-1">
<div id="wb_page2Login1">
<form name="loginform" method="post" accept-charset="UTF-8" action="<?php echo basename(__FILE__); ?>" id="loginform">
<input type="hidden" name="form_name" value="loginform">
<table id="page2Login1">
<tr>
...
<tr>
   <td id="wb_uid5"><input class="button" type="submit" name="login" value="Log In" id="login"></td>
</tr>
</table>
</form>
...
<div class="col-2">
<div id="wb_page2LoginName1">
<span id="page2LoginName1">Welcome <?php
...
<div class="col-1">
<div id="wb_Text10">
<span id="wb_uid6"><strong>Follow Us</strong></span>
</div>
...
<div class="col-1">
<div id="wb_Image8">
<a href="./index.html"><img src="images/placeholder.gif" data-src="images/third%20eye%203%20png.png" id="Image8" alt=""></a>
</div>
<div id="wb_Image7">
<img src="images/website.png" id="Image7" alt="">
</div>
<div id="wb_Text8">
<p id="wb_uid7"><span id="wb_uid8">©</span><span id="wb_uid9"> Copyright 2021 Third Eye Creation</span></p>
</div>
<div id="wb_Text7">
<p id="wb_uid10"><span id="wb_uid11">Designed &amp; Developed by </span><a href="https://developer.dristikononline.in">Kaustav Roy</a></p>
</div>
</div>
</div>
</div>
